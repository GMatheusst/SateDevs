<div class="col-3 text-end">
    ...
    <button type="button" class="btn btn-outline-danger" data-bs-toggle="modal" data-bs-target="#staticBackdropApC">
        <i class="bi bi-trash2"></i>
    </button>

    <!-- Modal -->
    <div class="modal fade" id="staticBackdropApC" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="../funcao/Apagar.php" method="post">
                    <input type="hidden" name="idForm" value="apCat">
