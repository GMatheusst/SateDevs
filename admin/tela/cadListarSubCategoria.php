                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <form action="../funcao/Inserir.php" method="post">
                                <input type="hidden" name="idForm" value="CRSub">
                    ...
                    <i class="bi bi-trash text-danger" title="Excluir"></i>
                        ...
                        <tbody>
                           <?php
                            ...
                            $categorias = new MostrarSubCategorias();
                            $categorias->setNumPagina(@$_GET["pg"]);
                            $categorias->setUrl("?tela=cadListarSubCategoria");
                            $categorias->setSessao("");
                            $categorias->mostrarSubCategorias();
                            ?>
