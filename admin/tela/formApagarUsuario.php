<div class="col-3 text-end">
    ...
    <button type="button" class="btn btn-outline-danger" data-bs-toggle="modal"
        data-bs-target="#staticBackdropApU<?php echo $i?>">
        <i class="bi bi-trash2"></i>
    </button>

    <!-- Modal -->
    <div class="modal fade" id="staticBackdropApU<?php echo $i?>" data-bs-backdrop="static" data-bs-keyboard="false"
        tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header border-0">
                    <h1 class="modal-title fs-5" id="staticBackdropLabel">Deseja apagar o produto selecionado?</h1>
                </div>
