    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="../funcao/Atualizar.php" method="post">
                <input type="hidden" name="idForm" value="atCat">
                <input type="hidden" name="id" value="<?php echo $dados['idCategoria']; ?>">
                <div class="modal-body">
                    <div class="text-start border px-1 py-1 mb-1">
                        <label for="nome" class="lead fs-6">Nome da Categoria</label>
                        <input type="text" name="nome" value="<?php echo $dados['nomeCategoria']; ?>" id="" class="input border-0 border-bottom">
                    </div>
                    <div class="text-start border px-1 py-1 mb-1">
                        <label for="desc" class="lead fs-6">Descrição da Categoria</label>
                        <input type="text" name="desc" value="<?php echo $dados['descCategoria']; ?>" id="" class="input border-0 border-bottom">
                    </div>
                </div>
