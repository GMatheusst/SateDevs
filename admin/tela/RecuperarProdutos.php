<div class="col-3 text-end">
    ...
    <button type="button" class="btn btn-outline-success" data-bs-toggle="modal" data-bs-target="#staticBackdropApC<?php echo $i;?>">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header border-0">
                    <h1 class="modal-title fs-5" id="staticBackdropLabel">Deseja Recuperar Este Item</h1>
                </div>
                <form action="../funcao/Apagar.php" method="post">
                    ...
                    <div class="modal-footer border-0">
                        ...
                        <button type="submit" class="btn btn-info" name="apP">Sim</button>
                    </div>
                </form>
            </div>
        </div>
